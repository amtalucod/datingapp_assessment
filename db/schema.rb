...
ActiveRecord::Schema[7.1].define(version: 2024_04_03_063809) do
  ...
  add_foreign_key "swipes", "users", column: "disliked_user_id"
  add_foreign_key "swipes", "users", column: "liked_user_id"
end
